...
class Adafruit_SPITFT : public Adafruit_GFX {
  ...
  public:
    ...
    Adafruit_SPITFT(uint16_t w, uint16_t h, SPI &spiClass, PinName cs, PinName dc, PinName rst);
  ...
  protected:
    ...
    DigitalOut    _rst;            ///< Reset pin # (or -1)
    DigitalOut    _cs;             ///< Chip select pin # (or -1)
    DigitalOut    _dc;             ///< Data/command pin #
